...
Alright let's get back to basics here. HTML5 Canvas is very versatile and capable of both 2d and 3d graphics. It is used abundantly in the eye-candy websites featured on [awwwards](https://www.awwwards.com/) and [siteinspire](https://www.siteinspire.com/).

While building one of my older [portfolio websites](https://portfolio-v4-abjt14.vercel.app/), I built a drawable background that auto-fills once half the Canvas has been drawn on. In order to make this work, I had to calculate the transparency percentage of the Canvas.
